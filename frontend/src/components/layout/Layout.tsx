      ...
      <div
        ...
        style={{
          background: isDark
            ...
            `
            : `
              radial-gradient(ellipse 80% 50% at 20% 40%, rgba(184, 134, 11, 0.06) 0%, transparent 60%),
              radial-gradient(ellipse 60% 40% at 80% 20%, rgba(139, 92, 246, 0.04) 0%, transparent 50%),
              radial-gradient(ellipse 50% 60% at 50% 90%, rgba(180, 160, 120, 0.08) 0%, transparent 50%),
              var(--color-bg-primary)
            `,
        }}
      />

      {/* 3D particle starfield (dark mode only) */}
      {isDark && (
        <Suspense
          fallback={
